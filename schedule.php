...
<?php $results = mysqli_query($db, "SELECT * FROM excursions INNER JOIN schedule ON excursions.Excursions_ID = schedule.Excursions_ID INNER JOIN guest ON schedule.Guest_ID=guest.Guest_ID"); ?>
